...
module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
  ...
  return "<div>\n  <h1>Foo: "
    + alias1(container.lambda((depth0 != null ? depth0.foo : depth0), depth0))
    + "</h1>\n  <h2>Index: "
    + alias1(__default(__webpack_require__(22)).call(alias2,{"name":"index","hash":{},"data":data}))
    + "</h2>\n  <p>I don't know: "
    + alias1(__default(__webpack_require__(23)).call(alias2,{"name":"whatIsGoingOn","hash":{},"data":data}))
    + "</p>\n</div>\n";
},"useData":true});
...
console.log('template output:', template({ foo: 'bar', index: 2, whatIsGoingOn: 'nothing' }));
...
module.exports = () => 'why is this happening?'
